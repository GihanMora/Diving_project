...
<div class="col-sm-12">
    <form class="form" action="equipment_edit.php?equipment_id=<?php echo $equipment_id; ?>" method="post" id="registrationForm">
        ...
        <div class="form-group">
            <div class="col-sm-1"></div>
            <div class="col-sm-10">
                <h3 style="padding: 30px;">Edit Equipment Information</h3>
...
if(isset($_POST['submit'])) {
    ...
    $query = "UPDATE `equipment` SET `long_description` = '$new_description',`Description` = '$new_s_description',`EquipName` = '$new_title' where EquipID = $equipment_id";
...
document.getElementById(`header_title`).value = `<?php echo "$eq_name";?>`;
</script>
<?php
