...
$query ="SELECT COUNT(BookingID) as freq,Course_Name FROM `booking` GROUP BY Course_Name";
if(isset($_POST['all'])){
    $query ="SELECT COUNT(BookingID) as freq,Course_Name FROM `booking` GROUP BY Course_Name";
}
if(isset($_POST['submit'])){
    ...
    $query ="SELECT COUNT(BookingID) as freq,Course_Name FROM `booking`  where DATE_FORMAT(Booking_Time,'%Y-%m-%d') >= '$start_date' and DATE_FORMAT(Booking_Time,'%Y-%m-%d') <= '$end_date' GROUP BY Course_Name";
}
...
<div class="col-sm-7">
    <div class="col-sm-9"  style="text-align: left;padding-left: 50px">
        <form class="form" action="courses_summary.php" method="post" id="registrationForm">
    ...
    <div class="col-sm-3" style="" >
        <form class="form" action="courses_summary.php" method="post" id="all">
    ...
    <div class="col-md-8 col-md-offset-2" style="padding: 50px">
        ...
        if($resultx->num_rows>0){
            ...
            while($row=mysqli_fetch_assoc($resultx)) {
                ...
                array_push($label_array,$row['Course_Name']);
                ?>
