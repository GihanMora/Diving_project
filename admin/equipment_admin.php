...
<body>
	<!---header-->
		...
		<!---banner-->
				...
				<div class="content">
                    <div class="row">
                        <div class="col-sm-12" style="text-align: right;padding: 50px" >
                            <a href="add_new_equipment.php">
                                <button type="button" class="btn btn-success">Add new equipment</button>
                            </a>
                        </div>
                    </div>
...
//        $long_description = $row['long_description'];
                                        ...
                                        <div class="col-md-4 event-grid" style="height: 600px">
                                            ...
                                            <a id="edit_link" href="equipment_edit.php?equipment_id=<?php echo $equipment_id; ?>"><button id="button1id" name="button1id" class="btn btn-success">Edit</button></a>
                                           <button onclick="ff()" id="lll" name="button1id" class="btn btn-danger">Delete</button>
                                            <script>
                                                function ff(){
                                                    if (confirm("Are you sure you want to delete this item?")) {
                                                        window.location="delete_equipment.php?equipment_id=<?php echo $equipment_id; ?>"
                                                    } else {
