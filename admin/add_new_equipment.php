...
<div class="container bootstrap snippet">
    <div class="row">
        ...
        <div class="row" style="padding-bottom: 30px">
            ...
            <form class="form" action="add_new_equipment.php" method="post" id="registrationForm" enctype="multipart/form-data">
                <div class="col-sm-3"><!--left col-->
                    <div class="text-center">
                        ...
                        <div style="font-weight: bold;padding-top: 15px">Upload the Equipment Image here</div>
                ...
                <div class="col-sm-9">
                    <form class="form" action="add_new_equipment.php" method="post" id="registrationForm">
                        <div class="form-group">

                            <div class="col-xs-8">
                                <label ><h4>Equipment Name</h4></label>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <br>
                                <button class="btn btn-lg btn-success" name="submit" type="submit"> Add Equipment</button>
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO equipment (EquipName, Description, image,long_description)
	        VALUES ('$title','$s_des','$imagetmp','$f_des')";
        $resultset= $conn->query($sql);
        echo '<script>window.location = "equipment_admin.php";</script>';
    }
        ?>
</div>
</body>
